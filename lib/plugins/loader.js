...
const icqqSegment = (await import("icqq")).segment;

const segmentProxyHandler = {
  get(target, prop, receiver) {
    logger.warn("直接调用全局变量 segment 的方法或属性 " + prop + " 已过时，请通过 e.segment 访问。\n调用堆栈: " + (new Error()).stack);
...
global.segment = new Proxy(icqqSegment, segmentProxyHandler)
